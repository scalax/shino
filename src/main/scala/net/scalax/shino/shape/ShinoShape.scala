...
trait ShinoShape[Poly, Rep] {
  ...
  def toLaw: Shape[FlatShapeLevel, Rep, Data, Target] = new Shape[FlatShapeLevel, Rep, Data, Target] {
    ...
    override def buildParams(extract: Any => Unpacked): Target            = throw new SlickException("Shino does not provide buildParams implements.")
...
object ShinoShape {
  ...
  def auto[Rep, Data, Target](implicit shape: ShinoShape.Aux[ShapePoly, Rep, Data, Target]): Shape[FlatShapeLevel, Rep, Data, Target] = shape.toLaw
}
